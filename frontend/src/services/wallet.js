...
export const adminGetPlatformAccount = ()       => api.get('/wallet/admin/platform-account/')
export const adminUpdatePlatformAccount = (data) => api.patch('/wallet/admin/platform-account/', data)
