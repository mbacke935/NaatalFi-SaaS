  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Suivi des réclamations et arbitrages vendeur.</p>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-4 mb-6">
        {[
          ...
          { label: 'Résolus',   value: 0, icon: FiCheckCircle,   tone: 'text-green-400'  },
        ].map((item) => {
      ...
      <div className="bg-[#16161E] border border-[#2a2a3a] rounded-xl p-12 text-center">
        ...
        <p className="text-sm text-gray-500 max-w-md mx-auto mb-5">
          Les litiges seront alimentés par le module de protection acheteur/vendeur. Les commandes restent gérables depuis la page commandes.
        </p>
