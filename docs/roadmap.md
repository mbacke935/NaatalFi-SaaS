...
Resultat actuel : backend complet **104 tests OK** ; frontend **21 tests OK** ; build Vite OK. Derniers ajouts : checkout invite, variante incompatible bloquee, produit de vendeur non approuve bloque, coordonnees client invite visibles cote vendeur.
