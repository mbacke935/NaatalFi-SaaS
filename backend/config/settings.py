...
WAVE_BUSINESS_PAYMENT_URL = os.getenv('WAVE_BUSINESS_PAYMENT_URL', '')
WAVE_BUSINESS_ACCOUNT_NAME = os.getenv('WAVE_BUSINESS_ACCOUNT_NAME', '')
...
JWT_REFRESH_COOKIE_NAME = os.getenv('JWT_REFRESH_COOKIE_NAME', 'naatalfi_refresh')
